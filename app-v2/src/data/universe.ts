/**
 * Galaxies, nebulae, clusters and other deep-space objects.
 * Ported verbatim from the v1 `js/universeData.js`; only types were added.
 */
import type {
  UniverseData,
  GalaxyData,
...
export const UNIVERSE_DATA: UniverseData = {
...
export const GALAXIES: Record<string, GalaxyData> = {
    andromeda: {
...
// Nebulae Data
export const NEBULAE: Record<string, NebulaData> = {
    orion: {
...
// Star Clusters
export const STAR_CLUSTERS: Record<string, StarClusterData> = {
    pleiades: {
        name: "Pleiades (M45)",
        type: "Open Cluster",
...
export const EXOTIC_OBJECTS: Record<string, ExoticObjectData> = {
    sagittariusAStar: {
        name: "Sagittarius A*",
...
// Cosmic Structures
export const COSMIC_STRUCTURES: Record<string, CosmicStructureData> = {
    greatWall: {
...
export const VIEW_SCALES: Record<ViewScaleId, ViewScale> = {
    solarSystem: {
        name: "Solar System",
        maxDistance: 500,
